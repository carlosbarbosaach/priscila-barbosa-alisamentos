...
import {
  ClientServicePriceService,
} from "./client-service-price.service.js";
 ...
 */
export async function getClientServicePriceOverviewController(
  request:
    FastifyRequest,
  ...
  const overview =
    await clientServicePriceService
      .findOverviewBySalon(
        salonId,
      );
